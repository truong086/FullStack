...
namespace thuongmaidientus1.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        {
            return await _productService.FindAll(name, account_name, type, page, pageSize);
        }
        ...
        public async Task<PayLoad<object>> FindAllProductCategory([FromHeader]IList<string> id, int page = 1, int pageSize = 10)
        {
        ...
        public async Task<PayLoad<string>> DeleteProduct([FromHeader]IList<string> id)
        {
